...
document scanner,OCR,receipts,files,search,paper,archive,statements,privacy
...
- [x] iPhone 6.9-inch screenshots
- [x] iPhone 6.5-inch screenshots
- [x] iPad 13-inch screenshots
